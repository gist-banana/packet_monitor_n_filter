...
struct ip_hdr { // total : 64 64 64 64
    u32 ip_src;
    u32 ip_dst; // 64 one 
    u16 ip_ttl;
    u16 ip_hchecksum;
...
def print_skb_event(cpu, data, size):
    ...
    print("source : %s | destination : %s | ttl : %d | hchecksum : %d | ver : %d | hlen : %d | tos : %d | tlen : %d | identification : %d | nextp: %d | ffo_unused : %d | df :%d | mf : %d | foffset : %d" % (decimal_to_human(str(skb_event.ip_src)), decimal_to_human(str(skb_event.ip_dst)), skb_event.ip_ttl, skb_event.ip_hchecksum, skb_event.ip_ver, skb_event.ip_hlen, skb_event.ip_tos, skb_event.ip_tlen, skb_event.ip_identification, skb_event.ip_nextp, skb_event.ip_ffo_unused, skb_event.ip_df, skb_event.ip_mf, skb_event.ip_foffset))
